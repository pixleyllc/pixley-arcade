// Super basic Tetris-style block drop game for demo purposes
...
function randomShape() {
  // Only using square and line blocks for simplicity
  const shapes = [
...
function rotate() {
  // basic 90deg rotation for demo, works for most shapes
